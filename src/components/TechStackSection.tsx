...
import { Server, Database, Cpu, Monitor, BarChart3, Link } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          {techStack.map((tech, index) => (
            <div 
              key={tech.layer}
              className="group bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-6 hover:bg-white/20 transition-all duration-300 hover-scale animate-fade-in"
